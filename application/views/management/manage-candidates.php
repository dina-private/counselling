                    ...
                    <div class="row development_content table-responsive">
                        <table id="data-table" class="display" cellspacing="0" width="100%">
                            ...
                            <tr class="filter-data">
                                ...
                                <th><input type="text" name="mobile" data-column="2" class="filter-column"></th>
                                <th>
                                    <select name="state" class="filter-column selectpicker" style="width: 100%"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var orgTable = $('#data-table').DataTable({
            "processing": true,
            "serverSide": true,
            "searching": false,
            "ordering": false,
            "ajax": {
                "url": "Candidate/ajaxHandler",
                "type": "POST",
                "data": function (d) {
                    d.method = 'getCandidates';
                    $.extend(d, generateField($('#data-table')));
                }
            },
            "columns": [
                {"data": "name"},
